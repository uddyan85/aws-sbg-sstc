...
const tracks = [
  {
    level: "AWS",
    title: "Cloud Foundations & AWS Career Growth",
    description:
      "Explore AWS foundations, certifications, cloud career pathways, community opportunities, and continuous learning for real-world career growth.",
  ...
  },
  {
    ...
    description:
      "Explore AWS compute, containers, serverless, storage, databases, migration, and disaster recovery to build scalable, resilient, and cost-effective applications.",
  ...
  },
  {
    ...
    description:
      "Explore Generative AI, agentic applications, AWS AI capabilities, and real-world AI workflows for modern software development.",
    color: "from-fuchsia-500 to-violet-600",
    gradient: "fuchsia",
  },
  {
    level: "DevOps",
    title: "DevOps, Automation & Cloud-Native",
    description:
      "Explore DevOps, CI/CD, Infrastructure as Code, containers, and automation to build, deploy, and scale reliable applications efficiently.",
    color: "from-indigo-500 to-purple-600",
    gradient: "indigo",
  },
  {
    level: "Security",
    title: "Cloud Security, Zero Trust & Resilience",
    description:
      "Explore AWS security, IAM, Zero Trust, threat-aware architecture, and resilient security practices for protecting cloud workloads.",
    color: "from-rose-500 to-red-600",
    gradient: "rose",
  },
  {
    level: "Career",
    title: "Women in Tech, Community & Leadership",
    description:
      "Hear from technology leaders about career journeys, leadership, community building, mentorship, and creating a more inclusive technology ecosystem.",
  ...
  return (
    ...
    >
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        ...
        {/* ===== TRACKS ===== */}
        <motion.div
          className="mt-15 grid gap-8 lg:grid-cols-3"
                  ...
                  <div className="relative z-10 p-8">
                    <motion.span
                      className={`
                                                ...
                                                text-[#000000] bg-white/70 backdrop-blur-xl
                                            `}
        ...
        {/* ===== ROADMAP STRIP ===== */}
        <motion.div
          className="mt-15 overflow-hidden rounded-[40px] border border-[#A45AFA]/20 bg-white/[0.03] backdrop-blur-xl relative"
          initial={{ opacity: 0, y: 40 }}
          animate={isInView ? { opacity: 1, y: 0 } : {}}
          ...
          <div className="relative">
            ...
            <div className="relative z-10 flex flex-col items-center justify-between gap-10 p-10 lg:flex-row">
              <div>
                ...
                >
                  Learn{" "}
                  <span className="text-[#A45AFA]">→</span> Build{" "}
                  <span className="text-[#A45AFA]">→</span> Grow
                </motion.h3>
              ...
              >
                <motion.div
                  className="bg-gradient-to-r from-[#FF9900] via-[#FFE0A3] to-[#FF9900] bg-clip-text text-7xl md:text-8xl font-black text-transparent"
                  animate={{
                    backgroundPosition: ["0% 50%", "100% 50%", "0% 50%"],
                  }}
                  transition={{
                ...
                <p
                  className="mt-2 text-sm uppercase text-[#A45AFA] tracking-[0.4em] text-slate-500"
                  style={{ color: "#fa9a5a" }}
                >
